...
if ($password==$password2) {
	$query = mysqli_query($link_db, "INSERT INTO tbl_user (username, password, level, status) VALUES ('$username', '$password', 'pelanggan', 'tidak terblokir')");
	if ($query) {
		...
		if ($query2) {
			echo "<script>alert('Berhasil Buat Akun, Silahkan Login')</script>";
